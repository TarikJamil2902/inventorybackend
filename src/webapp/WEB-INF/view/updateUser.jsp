...
<body>
    ...
    <form action="/save" method="post">
        ...
        <input type="datetime-local" id="dob" name="dateOfBirth" value="${employee.dateOfBirth}" /><br>

        <label for="salary">Salary:</label>
        <input type="number" id="salary" name="salary" value="${employee.salary}" step="0.01" /><br>
